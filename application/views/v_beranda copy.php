...
<head>
    ...
    <title>E-Lapor</title>
    <link rel="icon" href="<?= base_url('assets/images/logo_uniku.png') ?>">
    <!-- Bootstrap core CSS -->
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">E-Lapor</a>
    ...
    <header class="masthead">
        <div class="container d-flex h-100 align-items-center">
            <div class="mx-auto text-center">
                <h1 class="mx-auto my-0 text-uppercase">E-Lapor</h1>
                <h2 class="text-white-50 mx-auto mt-2 mb-5">Laporkan insiden yang anda alami dan akan kami tangani
                    dengan cepat</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <h2 class="text-white mb-4">Apa itu E-Lapor?</h2>
                    <p class="text-white-50">E-Lapor adalah sebuah website dari Partai Politik untuk 
                        merekap data aspirasi dan aduan dari masyarakat.
                    </p>
                </div>
            </div>
            <img src="<?php echo base_url(); ?>/assets/beranda/images/.jpeg" class="img-fluid" alt=""
                style="max-width: 50%">
        </div>
    </section>
            ...
            <div class="row align-items-center no-gutters mb-4 mb-lg-5">
                <div class="col-xl-8 col-lg-7">
                    <img class="img-fluid mb-3 mb-lg-0"
                        src="<?php echo base_url(); ?>/assets/beranda/images/masalah.jpg" alt="" style="width: 100%">
                </div>
                <div class="col-xl-4 col-lg-5">
                    <div class="featured-text text-center text-lg-left">
                        <h4>Laporkan Masalah</h4>
                        <p class="text-black-50 mb-0">Laporkan masalah yang terjadi dan ceritakan kepada kami apa yang
                            terjadi.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="bg-black text-center h-100 project">
                        <div class="d-flex h-100">
                            <div class="project-text w-100 my-auto text-center text-lg-left">
                                ...
                                <p class="mb-0 text-white-50">Tim professional kami akan segera menganalisis masalah
                                    anda dengan cepat dan tepat.</p>
                    ...
                    <div class="bg-black text-center h-100 project">
                        <div class="d-flex h-100">
                            <div class="project-text w-100 my-auto text-center text-lg-right">
                                ...
                                <p class="mb-0 text-white-50">Dapatkan solusi dari kami yang akan berguna dan membantu
                                    masalah anda.</p>
    ...
    <section class="contact-section bg-black" id="signup">
        <div class="container">
                ...
                <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card py-4 h-100">
                        <div class="card-body text-center">
                            ...
                            <hr class="my-4">
                            <div class="small text-black-50">Kampus 2, Universitas Kuningan, Jl. Pramuka</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="social d-flex justify-content-center">
                <a href=#" target="blank" class="mx-2">
    ...
    <footer class="bg-black small text-center text-white-50">
        <div class="container">
            Copyright &copy; Fakultas Ilmu Komputer 2022
        </div>
    </footer>
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                                aria-controls="profile" aria-selected="false">Masuk</a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <form method="post" action="<?php echo base_url('beranda/register'); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="inputTelepon" name="regTelp"
                                            placeholder="No Telepon">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-12 col-form-label">No
                                        Identitas(SIM/KTP)</label>
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="inputId" name="regId"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="password" class="form-control" id="inputPassword" name="regPass"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="radio" name="isOrgz" value="Individu" checked>Individual <br>
                                        <input type="radio" name="isOrgz" value="Organisasi">Organisasi
                                    </div>
                                </div>
                                <div id="organisasiDiv" style="display: none">
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea class="form-control" name="alamatOrg" id="alamatOrg"
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <button type="button" data-dismiss="modal"
                                            class="btn btn-danger btn-block">Batal</button>
                                    </div>
                                    <div class="col-sm-6">
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <form method="post" action="<?php echo base_url('beranda/login'); ?>">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-12 col-form-label">Email</label>
                                    <div class="col-sm-12">
                                        <input type="email" class="form-control" name="emailMasuk" id="inputEmailMasuk"
                                            placeholder="Email">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputPassword3" class="col-sm-12 col-form-label">Password</label>
                                    <div class="col-sm-12">
                                        <input type="password" class="form-control" name="passwordMasuk"
                                            id="inputPasswordMasuk" placeholder="Password">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6">
