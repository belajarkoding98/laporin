      ...
      <section class="content container-fluid">
        ...
        <div class="box box-solid">
          <div class="box-body">
            ...
            <?php if ($this->session->userdata('admin') == 1): ?>
            <ul class="nav nav-pills nav-justified" style="margin-bottom: 10px">
              <li class="active"><a style="background-color: #00a65a; border-color: #00a65a;" href="<?php echo base_url(); ?>admin/user_active">Aktif</a></li>
                <li><a href="<?php echo base_url(); ?>admin/pelapor_nonactive">Nonaktif</a></li>
              </ul>
              <?php endif ?>
