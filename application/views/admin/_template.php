    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index2.html" class="logo">
                ...
                <span class="logo-lg">E <b>Lapor</b></span>
            </a>
            ...
            <span class="input-group-btn">
              <button type="submit" name="search" id="search-btn" class="btn btn-flat"><i class="fa fa-search"></i>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li><a href="<?php echo base_url(); ?>admin"><i class="fa fa-link"></i> <span>Dashoard</span></a>
                    </li>
                    <?php if ($this->session->userdata('admin') == 1) : ?>
                    <li><a href="<?php echo base_url(); ?>admin/laporan"><i class="fa fa-link"></i>
                            <span>Laporan</span></a></li>
                    <?php endif ?>
                    <li><a href="<?php echo base_url(); ?>admin/progress"><i class="fa fa-link"></i> <span>Sedang
                                Ditangani</span></a></li>
                    <!-- <li class="treeview">
