          ...
          <div class="box-body">
            ...
            <ul class="nav nav-pills nav-justified" style="margin-bottom: 10px">
              <li><a href="<?php echo base_url(); ?>admin/progress">Sedang Ditangani</a></li>
                <li class="active"><a style="background-color: #dd4b39; border-color: #dd4b39;" href="<?php echo base_url(); ?>admin/progress_ditolak">Ditolak</a></li>
              </ul>
              <?php endif ?>
                ...
                if ($this->session->userdata('tipe') == null) {
                  if ($data->status == 1) {
                    ...
                    <select class="form-control" onchange="updateStatus('.$data->id_aduan.',this.value)">
                      ...
                      <option value="3" selected="selected">Batal Diproses</option>
                    </select>
                    ';
